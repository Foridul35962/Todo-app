    ...
    return (
        <div className="w-full">
            <div className="relative flex justify-center items-center">
                <input type="text" value={task} placeholder="Enter your task" className=" w-full h-12 border-3 border-gray-500 my-3.5 rounded-full text-white text-xl pl-4" onChange={addInput} onKeyDown={handleOnKeyDown} />
